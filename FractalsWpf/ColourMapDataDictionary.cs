...
namespace FractalsWpf
{
    ...
    {
        private static readonly Dictionary<string, double[][]> JetData = new()
        {
            {
                "red", new[]
                {
        ...
        private static readonly Dictionary<string, double[][]> GistSternData = new()
        {
            {
                "red", new[]
                {
        ...
        private static readonly Dictionary<string, Func<double, double>> OceanData = new()
        {
        ...
        private static readonly Dictionary<string, Func<double, double>> RainbowData = new()
        {
        ...
        private static readonly Dictionary<string, Func<double, double>> GnuPlotData = new()
        {
        ...
        private static readonly Dictionary<string, Func<double, double>> AfmHotData = new()
        {
        ...
        private static readonly Dictionary<string, Func<double, double>> GistHeatData = new()
        {
            { "red", x => 1.5 * x },
            { "green", x => 2 * x - 1 },
            { "blue", x => 4 * x - 3 }
